...
public class MyCamera {
	...
	public void setButtonTakeCellPicGone(){
		VandaAlert.setButtonTakeCellPicGone();
	}
	
	public void setButtonTakeCellPicVisibility(){
		VandaAlert.setButtonTakeCellPicVisibility();
	}
	...
	public void takePhotoAndChoosePhotos(final int maxCount,final ArrayList<String> chooseList) {
		VandaAlert.createPhotoDialog(mContext, new PhotoDialogInterface() {
			...
			public void takingCellPicture(Dialog mDialog) {
				mDialog.dismiss();
				Intent i = new Intent(((Activity) mContext),ChoosePicturesActivity.class);
				i.putExtra("maxCount", maxCount);
				i.putExtra("chooseList",chooseList);
