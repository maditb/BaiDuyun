package com.vanda.vandalibnetwork.progress;
...
public class ProgressWheel extends View {
	...
	private void parseAttributes(TypedArray a) {
		...
		if (a.hasValue(R.styleable.ProgressWheel_progress_bar)) {
			setText(a.getString(R.styleable.ProgressWheel_progress_bar));
		}
