...
public class RequestManager {
	...
	private static Cache openCache() {
		return new DiskBasedCache(CacheUtils.getExternalCacheDir(AppData.getContext()), 10 * 1024 * 1024);
	}
	...
	// public static BitmapDrawable mBitmapDrawable = new BitmapDrawable(AppData
	// .getContext().getResources(), mBitmap);
	//
	// public static Drawable[] mDrawable = new Drawable[] {
	// mDefaultImageDrawable, mBitmapDrawable, };
	// public static TransitionDrawable transitionDrawable = new
	// TransitionDrawable(
	// mDrawable);
	...
	public static void setNostra13ImageLoader() {
		DEFAULT_IMAGE_OPTIONS = new DisplayImageOptions.Builder()
				...
				.showImageOnLoading(mDefaultImageDrawable).build();/*
																	 * Builder().
																	 * cacheOnDisc
																	 * ().
																	 * cacheInMemory
		...
		DEFAULT_IMAGE_CONFIGS = new ImageLoaderConfiguration.Builder(
				...
				.discCache(
						new FileCountLimitedDiscCache(DEFAULT_IMAGE_CACHE_DIR,
								500))
				// default
				.discCacheSize(1024 * 1024).discCacheFileCount(500)
				...
				.build();
		mImageLoaderInstance = com.nostra13.universalimageloader.core.ImageLoader
				.getInstance();
