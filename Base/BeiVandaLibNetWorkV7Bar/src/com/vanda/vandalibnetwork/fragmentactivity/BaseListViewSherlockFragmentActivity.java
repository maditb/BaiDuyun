...
public abstract class BaseListViewSherlockFragmentActivity<T, K> extends
		BaseSherlockFragmentActivity<T> implements OnRefreshListener2<ListView> {
	...
	protected void onStart() {
		mPullToRefreshListView
				.setOnRefreshListener(BaseListViewSherlockFragmentActivity.this);
		super.onStart();
	}
		...
		Request<T> mLoadRequestData = new GsonRequest<T>(Method.GET, url,
				getResponseDataClass(), null, new Response.Listener<T>() {
					...
					public void onResponse(T response) {
						RequestManager
								.cancelAll(BaseListViewSherlockFragmentActivity.this);
					...
					public void onErrorResponse(VolleyError error) {
						...
						mPullToRefreshListView.onRefreshComplete();
						Toast.makeText(
								BaseListViewSherlockFragmentActivity.this,
