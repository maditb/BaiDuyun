...
package com.vanda.vandalibnetwork.view;
	...
	public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		if (a.hasValue(R.styleable.SlidingTabLayout_indicatorHeight)) {
			mTabStrip.setSelectedIndicatorHeight(a.getDimensionPixelSize(
					R.styleable.SlidingTabLayout_indicatorHeight, 0));
		}

		if (a.hasValue(R.styleable.SlidingTabLayout_selectedSlidingTabColor)) {
			mTabStrip.setSelectedIndicatorColor(a.getColor(
					R.styleable.SlidingTabLayout_selectedSlidingTabColor, 0));
		}
		...
		if (a.hasValue(R.styleable.SlidingTabLayout_dividerColor)) {
			mTabStrip.setDividerColor(a.getColor(
					R.styleable.SlidingTabLayout_dividerColor, 0));
		}
	...
	private void populateTabStrip() {
		...
		for (int i = 0; i < adapter.getCount(); i++) {
			...
			if (mTabViewTextAppearance != 0) {
				tabTitleView.setTextAppearance(getContext(),
						mTabViewTextAppearance);
			}
