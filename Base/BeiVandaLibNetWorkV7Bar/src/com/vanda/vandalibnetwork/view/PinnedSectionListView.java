...
public class PinnedSectionListView extends ListView {
	...
	private int getThemeBackgroundColor() {
		getContext().getTheme().resolveAttribute(
				android.R.attr.colorBackground, sTypedValue, true);
	...
	void createPinnedShadow(int position) {
		...
		if (sectionView != null) {
			Bitmap b = Bitmap.createBitmap(sectionView.getWidth(),
					sectionView.getHeight(), Bitmap.Config.ARGB_8888);
			...
			pinnedView = getAdapter().getView(position, null,
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		if (mPinnedSection != null) {
			...
			if (mTranslateY < 0) {
				final float percentage = Math.abs(mTranslateY)
