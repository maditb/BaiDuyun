...
public class PreferenceUtils {
	...
	public static boolean hasKey(final String key) {
		return PreferenceManager.getDefaultSharedPreferences(
				AppData.getContext()).contains(key);
	}
	...
	public static void increasePrefInt(final SharedPreferences sp,
			final String key) {
	...
	public static void increasePrefInt(final SharedPreferences sp,
			final String key, final int increment) {
	...
	public static void increasePrefLong(final SharedPreferences sp,
			final String key, final long increment) {
