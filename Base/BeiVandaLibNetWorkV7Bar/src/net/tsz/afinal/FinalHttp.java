...
public class FinalHttp {
  ...
  //------------------put 请求-----------------------
    ...
    public HttpHandler<DownloadParcel> specificDownload( String url,AjaxParams params, String target,boolean isResume, AjaxCallBack<DownloadParcel> callback,DownloadParcel downloadParcel) {
    	final HttpGet get =  new HttpGet(getUrlWithQueryString(url, params));
    	HttpHandler<DownloadParcel> handler = new HttpHandler<DownloadParcel>(httpClient, httpContext, callback,charset,downloadParcel);
    	handler.executeOnExecutor(executor,get,target,isResume);
    	return handler;
    }
