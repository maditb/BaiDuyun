...
public final class VandaAlert {
     ...
     * @param <T>
     * @param context    上下文
     * @param mListValue 显示单选条目的值
     * @param mListCode  选中条目后的返回代码，参数是T，必须保证mListValue的大小和mListCode的大小一致
     * @param title      Dialog 的标题参数
     * @param l          选中后的回调接口
     * @return 创建的Dialog
     */
    ...
    public static Dialog createPhotoDialog(final Context context,
        ...
        VandaAlert.mButtonTakeCellPic = mButtonTakeCellPic;
    ...
    public static void setButtonTakeCellPicGone() {
        if (VandaAlert.mButtonTakeCellPic != null) {
            VandaAlert.mButtonTakeCellPic.setVisibility(View.GONE);
        }
    }

    public static void setButtonTakeCellPicVisibility() {
        if (VandaAlert.mButtonTakeCellPic != null) {
            VandaAlert.mButtonTakeCellPic.setVisibility(View.VISIBLE);
        }
    }
    ...
    public static Dialog CreateOKorNODialog(Context context, String title,
        ...
        mCreateOKorNODialog.setCancelable(true);
    ...
    public static Dialog createLoadingDialog(final Context context, String msg) {
        ...
        if (msg != null || msg != "") ((TextView) v.findViewById(R.id.tv_loading)).setText(msg);
    ...
    public static Dialog createTextViewDialog(final Context context, String msg,final TextViewClickListener listener) {

        TextView view = new TextView(context);
        view.setText(msg);
        view.setPadding(20, 20, 300, 20);
        ...
        view.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.onTextViewClickListener();
            }
        });
        final Dialog textViewDialog = new Dialog(context, R.style.yes_or_no_dialog);
        textViewDialog.setCancelable(true);
        textViewDialog.setContentView(view);
        view.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
